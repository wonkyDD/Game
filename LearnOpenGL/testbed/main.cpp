...
int main()
{
    ...
    /** @todo 파일경로 */
    //Shader mainShader(FileSystem::getPath("main_vs.glsl").c_str(), FileSystem::getPath("main_fs.glsl").c_str());
    //Shader lightShader(FileSystem::getPath("light_vs.glsl").c_str(), FileSystem::getPath("light_fs.glsl").c_str());
    Shader mainShader("main_vs.glsl", "main_fs.glsl");
